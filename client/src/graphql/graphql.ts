...
export type GetReposQuery = { __typename?: "Query" } & {
...
export function useGetReposQuery(
  ...
  return ApolloReactHooks.useQuery<GetReposQuery, GetReposQueryVariables>(
    GetReposDocument,
    baseOptions
  );
}
export function useGetReposLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<GetReposQuery, GetReposQueryVariables>(
    GetReposDocument,
    baseOptions
  );
}
...
>;
export type GetReposQueryResult = ApolloReactCommon.QueryResult<
  GetReposQuery,
  GetReposQueryVariables
>;
